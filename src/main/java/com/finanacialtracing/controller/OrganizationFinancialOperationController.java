...
public class OrganizationFinancialOperationController {
    ...
    public CommonResult createOrgFO(@RequestBody FinancialOperationCreateDto financialOperationCreateDto) {
        log.info("Rest request to createOrgFO()");
        return OrganizationFinancialOperationService.createOrgFO(financialOperationCreateDto);
    }
